 ...
 * Install the dependencies by: `npm install`. Then, `cd` to `/main/static/main` and create a symlink to the installed dependencies using: `npm link jquery popper.js bootstrap katex open-iconic showdown` (Read more about `link` [here](https://docs.npmjs.com/cli/link)).
